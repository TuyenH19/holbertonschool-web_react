...
describe('notificationsSlice', () => {
  ...
  describe('showDrawer and hideDrawer', () => {
    test('should toggle the displayDrawer state correctly when the showDrawer action is dispatched', () => {
      const initialState = {
        notifications: [],
        displayDrawer: false,
      };
    ...
    test('should toggle the displayDrawer state correctly when the hideDrawer action is dispatched', () => {
      const initialState = {
        notifications: [],
        displayDrawer: true,
      };
    ...
    test('should handle multiple toggle actions correctly', () => {
      let state = {
        notifications: [],
        displayDrawer: false,
      };
